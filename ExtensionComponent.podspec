...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "Babu Gangatharan"
  # s.authors            = { "Babu Gangatharan" => "gbabucs@gmail.com" }
  # s.social_media_url   = "http://twitter.com/Babu Gangatharan"
  ...
  s.source       = { :git => "https://github.com/gbabucs/ExtensionComponent.git", :tag => "#{s.version}" }
